...
正如这个介绍所说的那样，thc 精神有可能就是自己一直在追求的那种精神

1. 公益跳板机：`ssh root@segfault.net`，密码 `segfault`
2. 公益 Telegram 代理，https://www.thc.org/t/
3. 公益邮件转发服务，`curl 'https://mail.thc.org/register?name=foobar&to=hackbart@tuta.io'`
